        ...
        case 1:  //켄
            switch( NA.Dir )
            {
                case 1:
                    ...
                    if( s == ken1[2][0] && s1 == ken1[2][1] ) return 3; //아조겐
		...
		case 2:  //가일
            switch( NA.Dir )
            {
                case 1:
                    ...
                    if( s == guile1[1][0] && s1 == guile1[1][1] ) return 2; //소니붐
                    if( s == guile1[2][0] && s1 == guile1[2][1] ) return 3; //대쉬
				break;
     		    case 2:
                    if( s == guile2[0][0] && s1 == guile2[0][1] ) return 1; //반달킥
                    if( s == guile2[1][0] && s1 == guile2[1][1] ) return 2; //소니붐
