...
void copy_page_x( int pg )
{
    ...
    for ( xxx = 0; xxx < 359; xxx++ )
    {
        for ( yyy = 0; yyy < 269; yyy++ )
        {
            ...
            // *(RowsX[yyy] + (xxx >> 2) + activeStart ) = page[pg][ ( 360 * yyy ) + xxx ];
        }
    }*/
    SDL_FillRect(screen, NULL, 0);
    //blit_raw(screen, 0, 0, (unsigned char*)page[pg], 360, 360, 270);
    blit_scaled_X2(screen, 0, 0, (unsigned char*)page[pg], 360, 360, 270);
    SDL_Flip(screen);
}
