            ...
            if ( at[act] != 0 )
            {
                ...
                for ( i3 = 0; i3 < 30; i3++ )
                {
                       ...
                       )
                    {
                        ...
                        if ( EN[i3].SHIELD == OFF ) EN[i3].ENERGY -= POW << strength;
                ...
                case 2: //ˆa·©
                    if ( at[act] != 0 && SPECIAL_TYPE != 3 )
                    {
                        for ( i3 = 0; i3 < 30; i3++ )
                        {
                            ...
                            {
                                EN[i3].DAMAGE_TYPE = at[act]; if ( EN[i3].SHIELD == OFF ) EN[i3].ENERGY -= POW << strength;
    ...
    for ( ii = 0; ii < 30; ii++ )
    {
        if ( EN[ii].THROW == ON )
        {
            ...
            for ( i3 = 0; i3 < 30; i3++ )
            {
                ...
                {
                    EN[i3].DAMAGE_TYPE = 2; if ( EN[i3].SHIELD == OFF ) EN[i3].ENERGY -= POW << strength;
                    EN[i3].damage_create();
...
void ENEMY :: player_check( void )
{
    if ( at[act] != 0 )
    {
        ...
        {
            NA.DAMAGE_TYPE = at[act], NA.ENERGY -= POW & damage;
